...
private slots:
    ...
    void on_BuyMMXIV_clicked();
    void on_SellMMXIVBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputMMXIV_textChanged(const QString &arg1);
    ...
    QString BuyMMXIV(QString OrderType, double Quantity, double Rate);
    QString SellMMXIV(QString OrderType, double Quantity, double Rate);
